...
import (
	...
	"github.com/kesilent/react-light-blog/models/common"
)
...
type SysUser struct {
	...
	HeaderImg     string         `json:"headerImg" gorm:"default:https://qmplusimg.henrongyi.top/RLB_header.jpg;comment:用户头像"`               // 用户头像
