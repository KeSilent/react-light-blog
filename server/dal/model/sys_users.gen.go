...
// SysUser 用户表
type SysUser struct {
	ID          int64          `gorm:"column:id;type:bigint;primaryKey;comment:用户ID" json:"id,string"`              // 用户ID
	...
	Authorities []SysAuthority `gorm:"foreignKey:id;joinForeignKey:sys_user_id;joinReferences:sys_authority_id;many2many:sys_user_authority;references:id" json:"authorities"`
}
